...
object Classification_Main{
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Decision Tree model can be created using Labeled histograms
    //Decisiontree.decisiontree(sc)

    //NaiveBayes model can be created using Labeled histogram
    //Naivebayes.nbclassification(sc)

    //RandomForest model can be created using Labeled histogram
    Randomforest.randomforest(sc)
    ...
    Classification_Evaluation.evaluateModel(pRDD)
