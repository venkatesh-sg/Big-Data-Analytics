...
object LinearRegressionwithSGD {
  ...
  def main(args: Array[String]): Unit ={
    ...
    val data = sc.textFile("input//Chimp.data")
    ...
    // Save and load model
    model.save(sc, "output//LinearRegressionWithSGDModel")
    val sameModel = LinearRegressionModel.load(sc, "output//LinearRegressionWithSGDModel")
  }
